...
| 2026-08-21 | **Un aspirante tiene entregas de JULIO 2026 sin calificar en U1, U2, U3 y U4** — anteriores al inicio de la cohorte (19-ago). Parece arrastre de una cohorte previa o un caso adelantado. Verificar si corresponde corregirlas. (Su `userid` está en `datos/pendientes-corregir.json`, que no se versiona.) | media | **abierto** |
